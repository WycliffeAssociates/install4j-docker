...
RUN apt-get update && \
    ...
    wget --no-verbose https://download-gcdn.ej-technologies.com/install4j/install4j_unix_9_0_2.tar.gz && \
...
ENV ORG_GRADLE_PROJECT_gradlewInstall4jDirectory=/install4j/install4j9.0.2
WORKDIR /repo
