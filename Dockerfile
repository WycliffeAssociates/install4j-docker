...
RUN apt-get update && \
    ...
    wget --no-verbose https://download.ej-technologies.com/install4j/install4j_linux-x64_11_0_2.tar.gz && \
    tar -zxf install4j_linux-x64_11_0_2.tar.gz
...
ENV ORG_GRADLE_PROJECT_gradlewInstall4jDirectory=/install4j/install4j11.0.2
WORKDIR /repo
